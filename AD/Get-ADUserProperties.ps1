...
if(Test-Path $InputFile){
 ...
 Get-Content $InputFile|%{ 
    ...
    Try { 
        ...
        Get-ADUser -Identity $User -Properties Title,Displayname,CanonicalName| Select samaccountname,@{l="Status";e={"Active"}},Displayname,Title,@{l="Identity";e={$_.CanonicalName}}
        
    }catch{
    
        {}|select @{l="samaccountname";e={$User}},@{l="Status";e={"InActive"}},Displayname,Title,Identity
